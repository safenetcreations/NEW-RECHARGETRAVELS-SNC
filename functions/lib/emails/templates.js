...
// ==========================================
const driverRegistrationTemplate = (data) => {
    const content = `
    <!-- Success Header -->
    <div style="text-align: center; margin-bottom: 32px;">
  ...
  `;
    return (0, exports.emailWrapper)(content, 'Driver Application Received - Recharge Travels', 'booking');
};
exports.driverRegistrationTemplate = driverRegistrationTemplate;
// ==========================================
// DRIVER APPROVAL EMAIL
// ==========================================
const driverApprovalTemplate = (data) => {
    const content = `
    <!-- Celebration Header -->
    <div style="text-align: center; margin-bottom: 32px;">
      <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 24px rgba(16,185,129,0.3);">
  ...
  `;
    return (0, exports.emailWrapper)(content, '🎉 You\'re Approved! Welcome to Recharge Travels', 'booking');
};
exports.driverApprovalTemplate = driverApprovalTemplate;
// ==========================================
// ADMIN: NEW DRIVER APPLICATION NOTIFICATION
// ==========================================
const adminDriverNotificationTemplate = (data) => {
    const content = `
    <!-- Alert Header -->
    <div style="text-align: center; margin-bottom: 32px;">
  ...
  `;
    return (0, exports.emailWrapper)(content, '🔔 New Driver Application - Action Required', 'booking');
};
exports.adminDriverNotificationTemplate = adminDriverNotificationTemplate;
// ==========================================
// VEHICLE RENTAL BOOKING CONFIRMATION
// ==========================================
const vehicleRentalConfirmationTemplate = (data) => {
    const content = `
    <!-- Success Header -->
    <div style="text-align: center; margin-bottom: 32px;">
      <div style="width: 80px; height: 80px; background: linear-gradient(135deg, ${BRAND_PRIMARY} 0%, #10b981 100%); border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 24px rgba(13,92,70,0.3);">
  ...
  `;
    return (0, exports.emailWrapper)(content, 'Vehicle Rental Confirmed - Recharge Travels', 'booking');
};
exports.vehicleRentalConfirmationTemplate = vehicleRentalConfirmationTemplate;
// ==========================================
// REVIEW REQUEST EMAIL
// ==========================================
const reviewRequestTemplate = (data) => {
    const content = `
  ...
  `;
    return (0, exports.emailWrapper)(content, "How Was Your Tour? Share Your Experience! - Recharge Travels", 'general');
};
exports.reviewRequestTemplate = reviewRequestTemplate;
// ==========================================
// INVOICE EMAIL
// ==========================================
const invoiceTemplate = (data) => {
  ...
  `;
    return (0, exports.emailWrapper)(content, `Invoice ${data.invoiceNumber} - Recharge Travels`, 'booking');
};
exports.invoiceTemplate = invoiceTemplate;
// ==========================================
// HOTEL BOOKING CONFIRMATION
// ==========================================
const hotelBookingTemplate = (data) => {
    const content = `
    <!-- Success Header -->
    <div style="text-align: center; margin-bottom: 32px;">
  ...
  `;
    return (0, exports.emailWrapper)(content, 'Hotel Booking Confirmed - Recharge Travels', 'booking');
};
exports.hotelBookingTemplate = hotelBookingTemplate;
// ==========================================
// DRIVER REJECTION EMAIL
// ==========================================
const driverRejectionTemplate = (data) => {
    const content = `
    <!-- Header -->
    <div style="text-align: center; margin-bottom: 32px;">
  ...
  `;
    return (0, exports.emailWrapper)(content, 'Driver Application Update - Recharge Travels', 'general');
};
exports.driverRejectionTemplate = driverRejectionTemplate;
exports.default = {
    ...
    // Driver templates
    driverRegistrationTemplate: exports.driverRegistrationTemplate,
    driverApprovalTemplate: exports.driverApprovalTemplate,
    adminDriverNotificationTemplate: exports.adminDriverNotificationTemplate,
    vehicleRentalConfirmationTemplate: exports.vehicleRentalConfirmationTemplate,
    // New additional templates
    reviewRequestTemplate: exports.reviewRequestTemplate,
    invoiceTemplate: exports.invoiceTemplate,
    hotelBookingTemplate: exports.hotelBookingTemplate,
    driverRejectionTemplate: exports.driverRejectionTemplate
};
