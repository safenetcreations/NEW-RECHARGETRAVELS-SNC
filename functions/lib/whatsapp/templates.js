...
exports.generateWhatsAppLink = exports.welcomeWhatsApp = exports.postTourFeedbackWhatsApp = exports.adminNewDriverWhatsApp = exports.adminNewBookingWhatsApp = exports.paymentReminderWhatsApp = exports.bookingReminderWhatsApp = exports.driverNewBookingWhatsApp = exports.driverApprovalWhatsApp = exports.driverRegistrationWhatsApp = exports.vehicleRentalWhatsApp = exports.transferBookingWhatsApp = exports.tourBookingWhatsApp = void 0;
...
// ==========================================
const tourBookingWhatsApp = (data) => `
🌴 *BOOKING CONFIRMED*
...
`;
exports.tourBookingWhatsApp = tourBookingWhatsApp;
const transferBookingWhatsApp = (data) => `
🚗 *TRANSFER CONFIRMED*
...
_${COMPANY_NAME}_ 🌴
`;
exports.transferBookingWhatsApp = transferBookingWhatsApp;
const vehicleRentalWhatsApp = (data) => `
...
_${COMPANY_NAME}_ 🌴
`;
exports.vehicleRentalWhatsApp = vehicleRentalWhatsApp;
// ==========================================
// DRIVER MESSAGES
// ==========================================
const driverRegistrationWhatsApp = (data) => `
...
`;
exports.driverRegistrationWhatsApp = driverRegistrationWhatsApp;
const driverApprovalWhatsApp = (data) => `
🎉 *CONGRATULATIONS!*
...
`;
exports.driverApprovalWhatsApp = driverApprovalWhatsApp;
const driverNewBookingWhatsApp = (data) => `
🔔 *NEW BOOKING ALERT*
...
_${COMPANY_NAME}_ 🌴
`;
exports.driverNewBookingWhatsApp = driverNewBookingWhatsApp;
// ==========================================
// REMINDERS & NOTIFICATIONS
// ==========================================
const bookingReminderWhatsApp = (data) => `
⏰ *BOOKING REMINDER*
...
_${COMPANY_NAME}_
`;
exports.bookingReminderWhatsApp = bookingReminderWhatsApp;
const paymentReminderWhatsApp = (data) => `
💳 *PAYMENT REMINDER*
...
_${COMPANY_NAME}_ 🌴
`;
exports.paymentReminderWhatsApp = paymentReminderWhatsApp;
// ==========================================
// ADMIN NOTIFICATIONS
// ==========================================
const adminNewBookingWhatsApp = (data) => `
🔔 *NEW BOOKING*
...
Action required! ⚡
`;
exports.adminNewBookingWhatsApp = adminNewBookingWhatsApp;
const adminNewDriverWhatsApp = (data) => `
...
`;
exports.adminNewDriverWhatsApp = adminNewDriverWhatsApp;
// ==========================================
// SUPPORT & FEEDBACK
// ==========================================
const postTourFeedbackWhatsApp = (data) => `
🌟 *HOW WAS YOUR TOUR?*
...
_${COMPANY_NAME}_ 💚
`;
exports.postTourFeedbackWhatsApp = postTourFeedbackWhatsApp;
const welcomeWhatsApp = (data) => `
...
_${COMPANY_NAME}_ 🙏
`;
exports.welcomeWhatsApp = welcomeWhatsApp;
// ==========================================
...
exports.default = {
    tourBookingWhatsApp: exports.tourBookingWhatsApp,
    transferBookingWhatsApp: exports.transferBookingWhatsApp,
    vehicleRentalWhatsApp: exports.vehicleRentalWhatsApp,
    driverRegistrationWhatsApp: exports.driverRegistrationWhatsApp,
    driverApprovalWhatsApp: exports.driverApprovalWhatsApp,
    driverNewBookingWhatsApp: exports.driverNewBookingWhatsApp,
    bookingReminderWhatsApp: exports.bookingReminderWhatsApp,
    paymentReminderWhatsApp: exports.paymentReminderWhatsApp,
    adminNewBookingWhatsApp: exports.adminNewBookingWhatsApp,
    adminNewDriverWhatsApp: exports.adminNewDriverWhatsApp,
    postTourFeedbackWhatsApp: exports.postTourFeedbackWhatsApp,
    welcomeWhatsApp: exports.welcomeWhatsApp,
    generateWhatsAppLink: exports.generateWhatsAppLink
};
