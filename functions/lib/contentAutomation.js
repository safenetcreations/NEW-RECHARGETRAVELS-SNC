...
exports.dailyContentAutomation = functions.pubsub
    ...
    try {
        ...
        const scheduledContent = await db.collection('contentCalendar')
            ...
            .get();
        const contentToGenerate = scheduledContent.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
        ...
        for (const item of contentToGenerate.slice(0, 2)) {
            try {
                ...
                results.push({
                    topic: item.topic,
                    category: (_b = item.category) === null || _b === void 0 ? void 0 : _b.name,
                    status: 'failed',
                    error: error.message
                });
            }
...
async function generateBlogContent(data) {
...
//# sourceMappingURL=contentAutomation.js.map