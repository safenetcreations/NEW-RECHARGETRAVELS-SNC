...
exports.searchTours = functions.https.onCall(async (data, context) => {
    try {
        ...
        toursSnapshot.forEach(doc => {
            var _a;
            const tour = Object.assign({ id: doc.id }, doc.data());
            const searchableText = `${tour.name} ${tour.description} ${(_a = tour.highlights) === null || _a === void 0 ? void 0 : _a.join(' ')}`.toLowerCase();
