...
const SENDGRID_API_KEY = ((_a = functions.config().sendgrid) === null || _a === void 0 ? void 0 : _a.api_key) || ((_b = functions.config().sendgrid) === null || _b === void 0 ? void 0 : _b.apikey) || process.env.SENDGRID_API_KEY || '';
...
const REDIS_URL = ((_c = functions.config().redis) === null || _c === void 0 ? void 0 : _c.url) || process.env.REDIS_URL || '';
let redis = null;
...
const emailTemplates = {
    ...
    airportTransferConfirmation: (data) => ({
          ...
          <div style="padding: 40px 30px;">
            ...
            <div style="background-color: #fef3c7; border-radius: 12px; padding: 25px; margin: 25px 0;">
              ...
              <ul style="color: #78350f; padding-left: 20px; margin: 0;">
                ${data.extras.map((extra) => `<li style="padding: 5px 0;">${extra}</li>`).join('')}
              </ul>
            </div>
            ` : ''}
    ...
    aiTripPlannerConfirmation: (data) => ({
          ...
          <div style="padding: 40px 30px;">
            ...
            <div style="background-color: #f0fdf4; border-radius: 8px; padding: 20px; margin: 20px 0;">
              ...
              <ul style="color: #166534; margin: 0; padding-left: 20px;">
                ${data.highlights.map((h) => `<li style="margin-bottom: 5px;">${h}</li>`).join('')}
              </ul>
            </div>
            ` : ''}
            ...
            <table style="width: 100%; margin: 20px 0; border-collapse: collapse;">
              ...
              <tr>
                <td colspan="2" style="padding: 12px; background: #ecfdf5; border-radius: 0 0 8px 8px;">
                  ...
                  <p style="color: #059669; font-size: 22px; font-weight: bold; margin: 5px 0 0;">LKR ${((_a = data.totalPrice) === null || _a === void 0 ? void 0 : _a.toLocaleString()) || data.totalPrice}</p>
                </td>
              </tr>
            </table>
...
Thank you for booking with Recharge Travels!
    ...
    trainBookingAdminNotification: (data) => {
        var _a, _b;
        return ({
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
          ...
          <div style="padding: 25px;">
            ...
            <div style="background: #ecfdf5; border-radius: 8px; padding: 15px; text-align: center;">
              ...
              <p style="color: #059669; margin: 5px 0 0; font-size: 28px; font-weight: bold;">LKR ${((_a = data.totalPrice) === null || _a === void 0 ? void 0 : _a.toLocaleString()) || data.totalPrice}</p>
            </div>
          ...
          <div style="background: #f9fafb; padding: 20px; text-align: center;">
            <a href="https://wa.me/${(_b = data.customerPhone) === null || _b === void 0 ? void 0 : _b.replace(/\\D/g, '')}"
    ...
    globalTourBookingConfirmation: (data) => ({
...
Recharge Travels Team
    ...
    globalTourBookingAdminNotification: (data) => {
        var _a;
        return ({
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
          ...
          <div style="padding: 30px;">
            ...
            <div style="text-align: center; margin: 25px 0;">
              ...
              <a href="https://wa.me/${(_a = data.customerPhone) === null || _a === void 0 ? void 0 : _a.replace(/\D/g, '')}?text=Hi%20${encodeURIComponent(data.customerName)}!%20Regarding%20your%20tour%20booking%20${data.bookingReference}..."
                 style="display: inline-block; background: #25D366; color: #ffffff;
                        text-decoration: none; padding: 12px 30px; border-radius: 25px; font-weight: bold; margin: 5px;">
                WhatsApp Customer
              </a>
...
const handleBookingConfirmation = async (snap, context) => {
    ...
    try {
        ...
        const customerEmail = ((_a = booking.personal_info) === null || _a === void 0 ? void 0 : _a.email) || booking.email || booking.customerEmail || booking.contactEmail || booking.user_email;
        ...
        const adminTemplate = emailTemplates.adminNotification({
            ...
            customerName,
            customerEmail,
            phone: ((_b = booking.personal_info) === null || _b === void 0 ? void 0 : _b.phone) || booking.phone || booking.customerPhone || booking.contactPhone,
            details: `
      ...
      `,
        ...
        const phone = ((_c = booking.personal_info) === null || _c === void 0 ? void 0 : _c.phone) || booking.phone || booking.customerPhone || booking.contactPhone;
        if (phone) {
...
exports.sendHillCountryBookingConfirmation = functions.firestore
    ...
    .onCreate(handleBookingConfirmation);
exports.sendRamayanaBookingConfirmation = functions.firestore
    .document('ramayana_bookings/{bookingId}')
    .onCreate(handleBookingConfirmation);
exports.sendBeachToursBookingConfirmation = functions.firestore
    .document('beach_bookings/{bookingId}')
    .onCreate(handleBookingConfirmation);
exports.sendCulinaryBookingConfirmation = functions.firestore
    .document('culinary_bookings/{bookingId}')
    .onCreate(handleBookingConfirmation);
// Airport Transfer Booking Confirmation Handler
const handleAirportTransferConfirmation = async (snap, context) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y;
    const booking = snap.data();
    const bookingId = context.params.bookingId;
    try {
        const customerEmail = (_a = booking.customerInfo) === null || _a === void 0 ? void 0 : _a.email;
        const customerName = ((_b = booking.customerInfo) === null || _b === void 0 ? void 0 : _b.name) || 'Valued Customer';
        if (!customerEmail) {
        ...
        const templateData = {
            ...
            pickupDate: ((_c = booking.routeInfo) === null || _c === void 0 ? void 0 : _c.date) || 'TBD',
            pickupTime: ((_d = booking.routeInfo) === null || _d === void 0 ? void 0 : _d.time) || 'TBD',
            pickupLocation: ((_e = booking.routeInfo) === null || _e === void 0 ? void 0 : _e.pickup) || 'TBD',
            dropoffLocation: ((_f = booking.routeInfo) === null || _f === void 0 ? void 0 : _f.dropoff) || 'TBD',
            distance: ((_g = booking.routeInfo) === null || _g === void 0 ? void 0 : _g.distance) || '',
            duration: ((_h = booking.routeInfo) === null || _h === void 0 ? void 0 : _h.duration) || '',
            vehicleType: ((_j = booking.vehicleInfo) === null || _j === void 0 ? void 0 : _j.vehicleName) || ((_k = booking.vehicleInfo) === null || _k === void 0 ? void 0 : _k.vehicleType) || 'Standard Vehicle',
            passengers: ((_l = booking.vehicleInfo) === null || _l === void 0 ? void 0 : _l.passengers) || 1,
            luggage: ((_m = booking.vehicleInfo) === null || _m === void 0 ? void 0 : _m.luggage) || 0,
            flightNumber: ((_o = booking.flightInfo) === null || _o === void 0 ? void 0 : _o.flightNumber) || '',
            arrivalTime: ((_p = booking.flightInfo) === null || _p === void 0 ? void 0 : _p.arrivalTime) || '',
            extras: ((_r = (_q = booking.extras) === null || _q === void 0 ? void 0 : _q.selectedExtras) === null || _r === void 0 ? void 0 : _r.map((e) => e.name)) || [],
            extrasTotal: ((_s = booking.extras) === null || _s === void 0 ? void 0 : _s.extrasTotal) || 0,
            baseFare: ((_t = booking.pricing) === null || _t === void 0 ? void 0 : _t.baseFare) || ((_u = booking.pricing) === null || _u === void 0 ? void 0 : _u.totalAmount) || 0,
            totalAmount: ((_v = booking.pricing) === null || _v === void 0 ? void 0 : _v.totalAmount) || 0,
            specialRequests: ((_w = booking.customerInfo) === null || _w === void 0 ? void 0 : _w.specialRequests) || ''
        };
        ...
        const adminTemplate = emailTemplates.adminNotification({
            ...
            customerName,
            customerEmail,
            phone: (_x = booking.customerInfo) === null || _x === void 0 ? void 0 : _x.phone,
            details: `
        <p><strong>Booking ID:</strong> ${templateData.confirmationNumber}</p>
        ...
        <p><strong>Payment:</strong> ${((_y = booking.paymentInfo) === null || _y === void 0 ? void 0 : _y.method) || 'Pending'}</p>
      `,
...
exports.sendAirportTransferConfirmation = functions.firestore
...
const handleTrainBookingConfirmation = async (snap, context) => {
    ...
    try {
        ...
        const emailData = {
            ...
            trainName: booking.trainName || ((_a = booking.train) === null || _a === void 0 ? void 0 : _a.trainName) || 'Sri Lanka Railways',
            trainNumber: booking.trainNumber || ((_b = booking.train) === null || _b === void 0 ? void 0 : _b.trainNumber) || '',
            departureStation: booking.departureStation || ((_c = booking.train) === null || _c === void 0 ? void 0 : _c.departureStation) || '',
            arrivalStation: booking.arrivalStation || ((_d = booking.train) === null || _d === void 0 ? void 0 : _d.arrivalStation) || '',
            departureTime: booking.departureTime || ((_e = booking.train) === null || _e === void 0 ? void 0 : _e.departureTime) || '',
            arrivalTime: booking.arrivalTime || ((_f = booking.train) === null || _f === void 0 ? void 0 : _f.arrivalTime) || '',
            travelDate: booking.travelDate || ((_g = booking.travelDetails) === null || _g === void 0 ? void 0 : _g.travelDate) || '',
            selectedClass: booking.selectedClass || ((_h = booking.travelDetails) === null || _h === void 0 ? void 0 : _h.ticketClass) || '',
            passengers: booking.passengers || ((_j = booking.travelDetails) === null || _j === void 0 ? void 0 : _j.passengers) || 1,
            totalPrice: booking.totalPrice || ((_k = booking.pricing) === null || _k === void 0 ? void 0 : _k.totalPrice) || 0,
            customerName: booking.customerName || ((_l = booking.customerInfo) === null || _l === void 0 ? void 0 : _l.name) || 'Valued Customer',
            customerEmail: booking.customerEmail || ((_m = booking.customerInfo) === null || _m === void 0 ? void 0 : _m.email) || '',
            customerPhone: booking.customerPhone || ((_o = booking.customerInfo) === null || _o === void 0 ? void 0 : _o.phone) || '',
            specialRequests: booking.specialRequests || ((_p = booking.travelDetails) === null || _p === void 0 ? void 0 : _p.specialRequests) || ''
        };
...
exports.sendTrainBookingConfirmation = functions.firestore
...
exports.resendTrainBookingConfirmation = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
    ...
    try {
        ...
        throw new functions.https.HttpsError('internal', (error === null || error === void 0 ? void 0 : error.message) || 'Failed to resend email');
    }
});
// Generate WhatsApp message link for train booking
exports.getTrainBookingWhatsAppLink = functions.https.onCall(async (data, context) => {
...
🚉 *Route:* ${booking.departureStation || ((_a = booking.train) === null || _a === void 0 ? void 0 : _a.departureStation)} → ${booking.arrivalStation || ((_b = booking.train) === null || _b === void 0 ? void 0 : _b.arrivalStation)}
🚂 *Train:* ${booking.trainName || ((_c = booking.train) === null || _c === void 0 ? void 0 : _c.trainName)} (${booking.trainNumber || ((_d = booking.train) === null || _d === void 0 ? void 0 : _d.trainNumber)})
📅 *Date:* ${booking.travelDate || ((_e = booking.travelDetails) === null || _e === void 0 ? void 0 : _e.travelDate)}
⏰ *Time:* ${booking.departureTime || ((_f = booking.train) === null || _f === void 0 ? void 0 : _f.departureTime)} - ${booking.arrivalTime || ((_g = booking.train) === null || _g === void 0 ? void 0 : _g.arrivalTime)}
🎫 *Class:* ${booking.selectedClass || ((_h = booking.travelDetails) === null || _h === void 0 ? void 0 : _h.ticketClass)}
👥 *Passengers:* ${booking.passengers || ((_j = booking.travelDetails) === null || _j === void 0 ? void 0 : _j.passengers)}

💰 *Total:* LKR ${(_l = (booking.totalPrice || ((_k = booking.pricing) === null || _k === void 0 ? void 0 : _k.totalPrice))) === null || _l === void 0 ? void 0 : _l.toLocaleString()}

📱 View ticket: https://www.rechargetravels.com/transport/train-booking/confirmation/${bookingId}

Thank you for booking with Recharge Travels! 🙏`;
        const customerPhone = (booking.customerPhone || ((_m = booking.customerInfo) === null || _m === void 0 ? void 0 : _m.phone) || '').replace(/\D/g, '');
        return {
            success: true,
        ...
        throw new functions.https.HttpsError('internal', (error === null || error === void 0 ? void 0 : error.message) || 'Failed to generate WhatsApp link');
    }
});
...
const handleGlobalTourBookingConfirmation = async (snap, context) => {
    ...
    try {
        ...
        const emailData = {
            ...
            travelers: `${((_a = booking.travelers) === null || _a === void 0 ? void 0 : _a.adults) || 1} Adults${((_b = booking.travelers) === null || _b === void 0 ? void 0 : _b.children) ? `, ${booking.travelers.children} Children` : ''}${((_c = booking.travelers) === null || _c === void 0 ? void 0 : _c.infants) ? `, ${booking.travelers.infants} Infants` : ''}`,
            pickupLocation: booking.pickupLocation || '',
            totalAmount: (((_d = booking.payment) === null || _d === void 0 ? void 0 : _d.totalAmountUSD) || 0).toLocaleString(),
            customerName: booking.customer ? `${booking.customer.firstName} ${booking.customer.lastName}` : 'Valued Customer',
            customerEmail: ((_e = booking.customer) === null || _e === void 0 ? void 0 : _e.email) || '',
            customerPhone: ((_f = booking.customer) === null || _f === void 0 ? void 0 : _f.phone) || '',
            nationality: ((_g = booking.customer) === null || _g === void 0 ? void 0 : _g.nationality) || '',
...
exports.sendGlobalTourBookingConfirmation = functions.firestore
...
exports.resendGlobalTourBookingConfirmation = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e, _f, _g;
    const { bookingId } = data;
    if (!bookingId) {
        throw new functions.https.HttpsError('invalid-argument', 'Booking ID is required');
...
exports.getGlobalTourBookingWhatsAppLink = functions.https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e, _f, _g;
    const { bookingId } = data;
    if (!bookingId) {
        throw new functions.https.HttpsError('invalid-argument', 'Booking ID is required');
...
⏱️ *Duration:* ${((_a = booking.tourDuration) === null || _a === void 0 ? void 0 : _a.days) || 0} Days / ${((_b = booking.tourDuration) === null || _b === void 0 ? void 0 : _b.nights) || 0} Nights
👥 *Travelers:* ${((_c = booking.travelers) === null || _c === void 0 ? void 0 : _c.adults) || 1} Adults${((_d = booking.travelers) === null || _d === void 0 ? void 0 : _d.children) ? `, ${booking.travelers.children} Children` : ''}
📍 *Pickup:* ${booking.pickupLocation}

💰 *Total:* $${(((_e = booking.payment) === null || _e === void 0 ? void 0 : _e.totalAmountUSD) || 0).toLocaleString()}

📱 View details: https://www.rechargetravels.com/booking/tour-confirmation/${bookingId}

Thank you for booking with Recharge Travels! 🙏`;
        const customerPhone = (((_f = booking.customer) === null || _f === void 0 ? void 0 : _f.phone) || ((_g = booking.customer) === null || _g === void 0 ? void 0 : _g.whatsappNumber) || '').replace(/\D/g, '');
        return {
            success: true,
            whatsappUrl: `https://wa.me/${customerPhone}?text=${encodeURIComponent(message)}`,
            message
...
const universalEmailTemplate = (data) => {
    ...
    const wrapInTemplate = (title, content, color = '#10b981') => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
exports.processWhatsAppQueue = functions.firestore
    ...
    try {
        ...
        await db.collection('whatsappMessages').add(Object.assign(Object.assign({}, messageData), { createdAt: admin.firestore.FieldValue.serverTimestamp(), fromQueue: messageId }));
        await snap.ref.update({
            status: 'processed',
            processedAt: admin.firestore.FieldValue.serverTimestamp()
        });
...
exports.sendPropertyListingEmail = functions.https.onCall(async (data, context) => {
...
exports.sendHotelBookingEmail = functions.https.onCall(async (data, context) => {
    const { type, bookingId, bookingReference, guestEmail, guestName, hotelName, roomType, checkIn, checkOut, nights, totalAmount, currency } = data;
