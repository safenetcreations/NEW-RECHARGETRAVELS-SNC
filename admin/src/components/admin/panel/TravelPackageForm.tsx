...
interface Props {
  ...
  onSubmit: (data: Omit<TravelPackage, 'id' | 'created_at'> | Partial<TravelPackage>) => void;
  onCancel: () => void;
}
  ...
  useEffect(() => {
    if (travelPackage) {
      setFormData({
        ...
        destinations: travelPackage.destinations.join(','),
  ...
  const handleGenerateContent = async () => {
    ...
    try {
      ...
      setFormData(prev => ({
        ...
        destinations: (generatedData.destinations || []).join(','),
        highlights: (generatedData.highlights || []).join(','),
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea id="destinations" name="destinations" value={formData.destinations} onChange={handleChange} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="highlights">Highlights (comma-separated)</Label>
            <Textarea id="highlights" name="highlights" value={formData.highlights} onChange={handleChange} />
          </div>
