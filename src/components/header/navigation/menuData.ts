...
export const aboutItems = [
  {
    title: "About Us",
    href: "/about",
    description: "Learn about Recharge Travels and our commitment to exceptional experiences"
  },
  {
  ...
  },
  {
    title: "Travel Guide",
    href: "/travel-guide",
    description: "Complete guide to planning your Sri Lankan adventure"
  },
  {
    title: "Contact Us",
    href: "/book-now",
...
export const exoticPackageItems = [
  {
    title: "Luxury Safari Expeditions",
    href: "/tours/luxury-safari",
    description: "Exclusive wildlife adventures with private guides and luxury lodges"
  },
  {
    title: "Honeymoon Packages",
    href: "/tours/honeymoon",
    description: "Romantic getaways designed for couples seeking unforgettable moments"
  },
  {
  ...
  },
  {
    title: "Luxury Tours",
    href: "/tours/luxury",
    description: "Premium experiences with exclusive accommodations and personalized service"
  }
]

export const scenicSriLankaItems = [
  {
    title: "Bambarakanda Falls",
    href: "/scenic/bambarakanda-falls",
    description: "Sri Lanka's tallest waterfall - A hiker's hidden gem"
  },
  {
    title: "Arugam Bay",
    href: "/scenic/arugam-bay-beach",
    description: "Surfing paradise with perfect waves and beach vibes"
  },
  {
    title: "Haputale Viewpoint",
    href: "/scenic/haputale-scenic-views",
    description: "Where heaven meets hills in misty tea country"
  },
  {
    title: "Diyaluma Falls",
    href: "/scenic/diyaluma-falls",
    description: "Natural infinity pools and Instagram-worthy views"
  },
  {
    title: "Ella Rock",
    href: "/scenic/ella-rock",
    description: "Rewarding sunrise hike with valley panoramas"
  },
  {
    title: "Gregory Lake",
    href: "/scenic/gregory-lake",
    description: "Tranquil boating in Nuwara Eliya's cool hills"
  },
  {
    title: "Pidurangala Rock",
    href: "/scenic/pidurangala-rock",
    description: "Best views of Sigiriya from this ancient rock"
  },
  {
    title: "Belihuloya River",
    href: "/scenic/belihuloya",
    description: "Nature escape with streams and forest retreats"
  },
  {
    title: "Ravana Falls",
    href: "/scenic/ravana-falls",
    description: "Mythical waterfall steeped in ancient legends"
  },
  {
    title: "Nine Arch Bridge",
    href: "/scenic/nine-arch-bridge",
    description: "Iconic colonial bridge with passing trains"
  }
]

export const familyActivityItems = [
  {
  ...
  },
  {
    ...
    description: "Family-friendly cycling through historical ruins and sacred sites"
  },
  {
  ...
  },
  {
    ...
    description: "Watch elephants bathe and feed them in a family-safe setting"
  },
  {
    title: "Turtle Hatchery",
    href: "/family-activities/kosgoda-turtle-hatchery",
    description: "Marine conservation experience with baby turtle releases"
  },
  {
    title: "Galle Fort Walk",
    href: "/family-activities/galle-fort-family-walk",
    description: "Colonial charm and coastal fun for the whole family"
  },
  {
    title: "Mask Making Workshop",
    href: "/family-activities/sri-lanka-mask-workshop",
    description: "Traditional Sri Lankan mask-making cultural experience"
  },
  {
    title: "Pearl Bay Water Park",
    href: "/family-activities/pearl-bay-water-park",
    description: "Water slides, karting, and fun rides for all ages"
  },
  {
    title: "Nuwara Eliya Parks",
    href: "/family-activities/nuwara-eliya-family-outing",
    description: "Paddle boats, pony rides, and playgrounds at Gregory Lake"
  }
]
...
export const blogItems = [
  ...
  },
  {
    ...
    href: "/blog",
    description: "Fresh content updated daily with travel insights"
  }
]

export const wildToursItems = [
  {
    title: "Wildlife Safaris",
    href: "/tours/wildtours",
...
export const transportItems = [
  {
    ...
    description: "Comfortable and reliable transfers to and from the airport"
  },
  {
    title: "Private Tours",
    href: "/transport/private-tours",
    description: "Customized transportation with experienced local drivers"
  },
  {
    title: "Group Transport",
    href: "/transport/group-transport",
    description: "Spacious vehicles for larger groups and families"
  },
  {
    title: "Train Booking Service",
    href: "/transport/train-booking",
    description: "Book scenic train journeys - Kandy to Ella, coastal routes & more"
  }
]
