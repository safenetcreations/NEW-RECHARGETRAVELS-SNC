...
// Tangalle coordinates
const TANGALLE_CENTER = { lat: 6.0235, lng: 80.7961 };
...
const defaultHeroSlides: HeroSlide[] = [
  { image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80", title: "Discover Tangalle", subtitle: "Unspoiled Southern Coast" },
  { image: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&q=80", title: "Tangalle Beach", subtitle: "Pristine Golden Sands" },
  { image: "https://images.unsplash.com/photo-1559827291-72ee739d0d9a?auto=format&fit=crop&q=80", title: "Turtle Hatchery", subtitle: "Sea Turtle Conservation" },
  { image: "https://images.unsplash.com/photo-1583212292454-1fe6229603b7?auto=format&fit=crop&q=80", title: "Mulkirigala Temple", subtitle: "Ancient Rock Temple" },
  { image: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&q=80", title: "Rekawa Lagoon", subtitle: "Turtle Nesting Beach" }
];
...
const Tangalle = () => {
  ...
  const handleBooking = (service: string = 'Tangalle Tour', tourData?: { id: string; name: string; description: string; duration: string; price: number; features: string[]; image?: string }) => {
    const params = new URLSearchParams({
      ...
      subtitle: `Tangalle - ${tourData?.name || service}`
    });
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-cyan-50 to-white">
            ...
            <div className="max-w-5xl mx-auto px-4">
              ...
              >
                <Button
                  ...
                  onClick={() => handleBooking('Tangalle Beach Getaway')}
                >
        ...
        <section className="container mx-auto px-4 py-12">
          ...
          {selectedTab === 'map' && (
            <div>
              <h2 className="text-3xl font-bold mb-8">Explore Tangalle Map</h2>
              <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                  <Card className="overflow-hidden h-[500px]">
                    <DestinationMap
                      destinationName="Tangalle"
                      center={TANGALLE_CENTER}
                      attractions={[
                        { name: 'Tangalle Beach', description: 'Beautiful sandy beach', coordinates: { lat: 6.0235, lng: 80.7961 } },
                        { name: 'Rekawa Turtle Beach', description: 'Turtle nesting sanctuary', coordinates: { lat: 6.0500, lng: 80.8500 } },
                        { name: 'Mulkirigala Rock Temple', description: 'Ancient cave temple', coordinates: { lat: 6.1200, lng: 80.7400 } },
                        { name: 'Hummanaya Blow Hole', description: 'Natural blowhole', coordinates: { lat: 6.0700, lng: 80.9000 } },
                        { name: 'Kalametiya Bird Sanctuary', description: 'Wetland bird reserve', coordinates: { lat: 6.0800, lng: 80.9500 } }
                      ]}
                      height="500px"
                    />
                  </Card>
                ...
                <div className="lg:col-span-1">
                  <WeatherWidget
                    locationName="Tangalle"
                    latitude={TANGALLE_CENTER.lat}
                    longitude={TANGALLE_CENTER.lng}
                  />
                </div>
              </div>
            </div>
      ...
      <a
        href="https://wa.me/94777721999?text=Hi! I'm interested in booking a Tangalle beach tour."
        target="_blank"
