...
import { vehicleService, vehiclePricingService } from '@/services/vehicleRentalService';
import type { Vehicle, VehicleType, VehicleSearchFilters, RentalPeriodType, VehiclePricing } from '@/types/vehicleRental';
import {
  Car,
  Filter,
  MapPin,
...
// Extended vehicle type with pricing
interface VehicleWithPricing extends Vehicle {
  pricing: { dailyRate: number; hourlyRate: number };
}
...
const VehicleBrowse = () => {
  ...
  const [filteredVehicles, setFilteredVehicles] = useState<VehicleWithPricing[]>([]);
  ...
  useEffect(() => {
    const fetchVehicles = async () => {
      try {
        ...
        const vehiclesWithPricing: VehicleWithPricing[] = await Promise.all(
  ...
  }, [vehicles, vehicleType, city, minSeats, maxPrice, sortBy]);
      ...
      <div className="min-h-screen bg-gray-50 pt-20">
        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-gray-300">Find your perfect rental from {vehicles.length} verified vehicles</p>
          </div>
        </div>
            ...
            <div className="flex-1">
              ...
              {error && (
                <div className="text-center py-16">
                  <Car className="w-16 h-16 mx-auto text-red-300 mb-4" />
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Error Loading Vehicles</h3>
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center gap-1 text-sm text-gray-500 mb-3">
                          ...
                          {vehicle.serviceAreas?.slice(0, 2).join(', ') || 'Location not specified'}
                          {vehicle.serviceAreas && vehicle.serviceAreas.length > 2 && ` +${vehicle.serviceAreas.length - 2}`}
                        </div>
              ...
              {/* Empty State */}
              {!error && filteredVehicles.length === 0 && !loading && (
                <div className="text-center py-16">
