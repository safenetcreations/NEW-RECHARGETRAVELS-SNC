            ...
            >
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-gray-500">
                  <a href="https://wa.me/94777721999" className="flex items-center gap-2 hover:text-green-600 transition-colors">
                  ...
                  <a href="mailto:info@rechargetravels.com" className="flex items-center gap-2 hover:text-orange-600 transition-colors">
